...
class shibboleth_idp (
  ...
  $attribute_filter_header   = $shibboleth_idp::params::attribute_filter_header,
  $attribute_filter_footer   = $shibboleth_idp::params::attribute_filter_footer,
  $attribute_resolver_header = $shibboleth_idp::params::attribute_resolver_header,
  $attribute_resolver_footer = $shibboleth_idp::params::attribute_resolver_footer,
